...
public class PostApi extends BaseApi {
     ...
     */
    public PostAttachmentResponse attachment1(UUID postId) throws RestClientException {
        return attachment1WithHttpInfo(postId).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PostAttachmentResponse> attachment1WithHttpInfo(UUID postId) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'postId' is set
        if (postId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'postId' when calling attachment1");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PostListResponse callList(UUID sessionId, Integer pageSize, Integer pageIndex) throws RestClientException {
        return callListWithHttpInfo(sessionId, pageSize, pageIndex).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PostListResponse> callListWithHttpInfo(UUID sessionId, Integer pageSize, Integer pageIndex) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'sessionId' when calling callList");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PostItemResponse query1(UUID sessionId, String body, String lang, UUID agentId) throws RestClientException {
        return query1WithHttpInfo(sessionId, body, lang, agentId).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PostItemResponse> query1WithHttpInfo(UUID sessionId, String body, String lang, UUID agentId) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'sessionId' when calling query1");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling query1");
        }
     ...
     */
    @Deprecated
    public PostItemResponse queryPostLegacy(UUID sessionId, String body, String lang, UUID agentId) throws RestClientException {
        return queryPostLegacyWithHttpInfo(sessionId, body, lang, agentId).getBody();
    }
     ...
     */
    @Deprecated
    public ResponseEntity<PostItemResponse> queryPostLegacyWithHttpInfo(UUID sessionId, String body, String lang, UUID agentId) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'sessionId' when calling queryPostLegacy");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling queryPostLegacy");
        }
        ...
        ParameterizedTypeReference<PostItemResponse> localReturnType = new ParameterizedTypeReference<PostItemResponse>() {};
        return apiClient.invokeAPI("/v1/post/", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
