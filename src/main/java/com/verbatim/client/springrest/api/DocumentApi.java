...
public class DocumentApi extends BaseApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public AckResponse delete3(UUID id) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<AckResponse> delete3WithHttpInfo(UUID id) throws RestClientException {
        Object localVarPostBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Document get3(UUID id) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Document> get3WithHttpInfo(UUID id) throws RestClientException {
        Object localVarPostBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Document update3(UUID id, DocumentUpdateRequest documentUpdateRequest) throws RestClientException {
        return update3WithHttpInfo(id, documentUpdateRequest).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Document> update3WithHttpInfo(UUID id, DocumentUpdateRequest documentUpdateRequest) throws RestClientException {
        Object localVarPostBody = documentUpdateRequest;
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling update3");
        }
        
        // verify the required parameter 'documentUpdateRequest' is set
        if (documentUpdateRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'documentUpdateRequest' when calling update3");
        }
